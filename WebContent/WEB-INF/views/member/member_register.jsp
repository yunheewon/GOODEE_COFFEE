...
<body>
   ...
   <script type="text/javascript">
	...
	<form method="POST" action="member_registerInsert" id="memberRegiFrm" name="memberRegiFrm">
		...
		<button id="memberRegiBtn" class="btn" name="memberRegiBtn" onclick="register();">회원등록</button>
	</form>
	<script>
	// 번호입력 자동으로 하이푼 생성
	...
	function register(){
		 ...
		 if($("#m_phone").val()==""){
			 ...
			 msgConfirm = confirm("등록하시겠습니까?");
			 if(msgConfirm)
		 	 	 $("#memberRegiFrm").submit();					 
			 else{
				//alert("ddd");
			 	return;
			 }
